...
namespace NickvisionMoney::Models::Update
{
    ...
    std::optional<UpdateConfig> UpdateConfig::loadFromUrl(const std::string& url)
    {
        ...
        std::string configFilePath = std::string(getpwuid(getuid())->pw_dir) + "/.config/Nickvision/NickvisionMoney/UpdateConfig.json";
