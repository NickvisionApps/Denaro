...
namespace Nickvision::Money::GNOME::Views
{
    PreferencesDialog::PreferencesDialog(const std::shared_ptr<PreferencesViewController>& controller, GtkWindow* parent)
        ...
        m_colorDialog{ gtk_color_dialog_new() }
    {
        //Build UI
        ...
        gtk_color_dialog_set_with_alpha(m_colorDialog, false);
        gtk_color_dialog_button_set_dialog(GTK_COLOR_DIALOG_BUTTON(gtk_builder_get_object(m_builder, "transactionColorButton")), m_colorDialog);
        gtk_color_dialog_button_set_dialog(GTK_COLOR_DIALOG_BUTTON(gtk_builder_get_object(m_builder, "transferColorButton")), m_colorDialog);
        gtk_color_dialog_button_set_dialog(GTK_COLOR_DIALOG_BUTTON(gtk_builder_get_object(m_builder, "groupColorButton")), m_colorDialog);
        gtk_color_dialog_button_set_dialog(GTK_COLOR_DIALOG_BUTTON(gtk_builder_get_object(m_builder, "accountCheckingColorButton")), m_colorDialog);
        gtk_color_dialog_button_set_dialog(GTK_COLOR_DIALOG_BUTTON(gtk_builder_get_object(m_builder, "accountSavingsColorButton")), m_colorDialog);
        gtk_color_dialog_button_set_dialog(GTK_COLOR_DIALOG_BUTTON(gtk_builder_get_object(m_builder, "accountBusinessColorButton")), m_colorDialog);
        //Signals
    ...
    {
        g_object_unref(G_OBJECT(m_colorDialog));
