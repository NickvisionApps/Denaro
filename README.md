...
1. Run `vcpkg install boost-date-time libnick matplotplusplus podofo rapidcsv gtest`
### Linux
1. Set the `VCPKG_DEFAULT_TRIPLET` environment variable to `x64-linux`
1. Run `vcpkg install boost-date-time libnick libxmlpp matplotplusplus podofo rapidcsv gtest`
