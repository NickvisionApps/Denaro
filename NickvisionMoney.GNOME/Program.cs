...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Fixed an issue where amounts were not updated when a transaction was deleted</li><li>Fixed an issue where some accounts could not Export To PDF</li><li>Updated and added translations (Thanks to everyone on Weblate)!</li></ul>";
