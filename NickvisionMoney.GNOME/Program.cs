...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Fixed an issue where the wrong group was selected in TransactionDialog</li><li>Various UX improvements</li></ul>";
