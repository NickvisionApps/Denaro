...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added the ability to remove recent accounts from the list</li><li>Moved deleting groups and transactions from their rows to their dialogs</li><li>Updated and added translations (Thanks to everyone on Weblate)!</li></ul>";
