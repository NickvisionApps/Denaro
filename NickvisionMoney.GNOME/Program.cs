...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added the ability to select a file to import existing data from in the new account setup dialog</li><li>Improved custom currency preferences design</li><li>Updated and added translations (Thanks to everyone on Weblate)!</li></ul>";
