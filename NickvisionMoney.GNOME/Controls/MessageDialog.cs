...
public partial class MessageDialog
{
    ...
    public MessageDialog(Gtk.Window parentWindow, string iconName, string title, string message, string? cancelText, string? destructiveText = null, string? suggestedText = null)
    {
