...
{
    DependencyProperty ViewStack::m_pagesProperty = DependencyProperty::Register(L"Pages", winrt::xaml_typename<IObservableVector<IInspectable>>(), winrt::xaml_typename<Nickvision::Money::WinUI::Controls::ViewStack>(), PropertyMetadata{ winrt::box_value(winrt::single_threaded_observable_vector<IInspectable>()) });
    ...
    void ViewStack::CurrentPage(const winrt::hstring& pageName)
    {
        ...
        {
            if(Nickvision::Money::WinUI::Controls::ViewStackPage page{ obj.try_as<Nickvision::Money::WinUI::Controls::ViewStackPage>() })
            {
