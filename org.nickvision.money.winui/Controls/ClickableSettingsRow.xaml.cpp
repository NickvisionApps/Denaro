...
{
    DependencyProperty ClickableSettingsRow::m_glyphProperty = DependencyProperty::Register(L"Glyph", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Money::WinUI::Controls::ClickableSettingsRow>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &ClickableSettingsRow::OnPropertyChanged } });
    DependencyProperty ClickableSettingsRow::m_titleProperty = DependencyProperty::Register(L"Title", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Money::WinUI::Controls::ClickableSettingsRow>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &ClickableSettingsRow::OnPropertyChanged } });
    DependencyProperty ClickableSettingsRow::m_descriptionProperty = DependencyProperty::Register(L"Description", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Money::WinUI::Controls::ClickableSettingsRow>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &ClickableSettingsRow::OnPropertyChanged } });
    DependencyProperty ClickableSettingsRow::m_childProperty = DependencyProperty::Register(L"Child", winrt::xaml_typename<IInspectable>(), winrt::xaml_typename<Nickvision::Money::WinUI::Controls::ClickableSettingsRow>(), PropertyMetadata{ nullptr, PropertyChangedCallback{ &ClickableSettingsRow::OnPropertyChanged } });
    ...
    {
        if(Nickvision::Money::WinUI::Controls::ClickableSettingsRow settingsRow{ d.try_as<Nickvision::Money::WinUI::Controls::ClickableSettingsRow>() })
        {
